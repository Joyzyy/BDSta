		...
		<div class="grid grid-cols-12">
			<div class="pb-6 col-span-full md:pb-0 md:col-span-6">
				<a href="#" class="flex justify-center space-x-3 md:justify-start">
					...
					<span class="self-center text-2xl font-semibold">Brand Distribution STA</span>
				</a>
			</div>
			<div class="col-span-6 text-center md:text-left md:col-span-3">
				<p class="pb-1 text-lg font-medium">Suport si asistenta</p>
				<ul>
					<li>
						<a href="#" class="hover:text-violet-600">Intrebari frecvente</a>
					</li>
					<li>
						<a href="#" class="hover:text-violet-600">Informatii retur</a>
					</li>
                    <li>
                        <a href="#" class="hover:text-violet-600">Informatii transport</a>
                    </li>
					<li>
						<a href="#" class="hover:text-violet-600">Modalitati de plata</a>
					</li>
				</ul>
			</div>
			<div class="col-span-6 text-center md:text-left md:col-span-3">
